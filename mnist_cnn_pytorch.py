...
class Net(nn.Module):
    def __init__(self):
        ...
        # self.fc1 = nn.Linear(640, 50) # generate 40 feature maps, each size is 4*4
        # self.fc2 = nn.Linear(50, 10)


        # #number of kernels shrink to 5 and 10 respectively
        # self.conv1 = nn.Conv2d(1, 5, kernel_size=5)
        # self.conv2 = nn.Conv2d(5, 10, kernel_size=5)
        # self.conv2_drop = nn.Dropout2d()
        # self.fc1 = nn.Linear(160, 50) # generate 10 feature maps, each size is 4*4
        # self.fc2 = nn.Linear(50, 10)
        ...
        # # Number of hidden layers = 2, each layer have 50 nodes
        # self.conv1 = nn.Conv2d(1, 10, kernel_size=5) # Input channel: 1, Output channel: 10, Filter size: 5x5
        # self.conv2 = nn.Conv2d(10, 20, kernel_size=5) # Input channel: 10, Output channel: 20, Filter size: 5x5
        # # randomly drop out 50% of the neurons
        # self.conv2_drop = nn.Dropout2d() # The default dropout rate is 50%
        ...
        # # Number of hidden layers = 3, each layer have 50 nodes
        # self.conv1 = nn.Conv2d(1, 10, kernel_size=5) # Input channel: 1, Output channel: 10, Filter size: 5x5
        # self.conv2 = nn.Conv2d(10, 20, kernel_size=5) # Input channel: 10, Output channel: 20, Filter size: 5x5
        # # randomly drop out 50% of the neurons
        # self.conv2_drop = nn.Dropout2d() # The default dropout rate is 50%
        ...
        # self.conv2 = nn.Conv2d(10, 20, kernel_size=5) # Input channel: 10, Output channel: 20, Filter size: 5x5
        # self.conv2_drop = nn.Dropout2d() # The default dropout rate is 50%
        # self.fc1 = nn.Linear(320, 20) # number of input neurons: 320, number of output neurons: 50
        # # 50 neurons fully connected layer.
        # self.fc2 = nn.Linear(20, 10) # Number of input neurons: 50, Number of output neurons: 10
        # # 10 neurons to represent our 10 classes.



        
        # Number of nodes in the hidden layer is increased to 80
        self.conv1 = nn.Conv2d(1, 10, kernel_size=5) # Input channel: 1, Output channel: 10, Filter size: 5x5
        self.conv2 = nn.Conv2d(10, 20, kernel_size=5) # Input channel: 10, Output channel: 20, Filter size: 5x5
        self.conv2_drop = nn.Dropout2d() # The default dropout rate is 50%
        self.fc1 = nn.Linear(320, 80) # number of input neurons: 320, number of output neurons: 50
        # 50 neurons fully connected layer.
        self.fc2 = nn.Linear(80, 10) # Number of input neurons: 50, Number of output neurons: 10
        # 10 neurons to represent our 10 classes.
